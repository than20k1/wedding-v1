...
!(function (t) {
  ...
  function q(n) {
    ...
    return (
      ...
      r.length
        ? ("0,0,0,0" === r.join() && l.extend(r, a.transparent), o)
        : a[n]
    );
  }
  function B(t, e, i) {
  ...
  function _(t, e, i, n) {
    return (
      ...
      (t = { effect: t }),
      null == e && (e = {}),
      b.isFunction(e) && ((n = e), (i = null), (e = {})),
      ("number" != typeof e && !b.fx.speeds[e]) || ((n = i), (i = e), (e = {})),
      b.isFunction(i) && ((n = i), (i = null)),
      e && b.extend(t, e),
      (i = i || e.duration),
      (t.duration = b.fx.off
        ? 0
  ...
  function M(t) {
    return (
      ...
      "number" == typeof t ||
      b.fx.speeds[t] ||
      ("string" == typeof t && !b.effects.effect[t]) ||
      b.isFunction(t) ||
  ...
  (b.effects = { effect: {} }),
    ...
    (h.fn = l.extend(h.prototype, {
      parse: function (o, t, e, i) {
        ...
        var r = this,
          ...
          s = (this._rgba = []);
        return (
          t !== u && ((o = [o, t, e, i]), (n = "array")),
          "string" === n
            ? this.parse(q(o) || a._default)
            : "array" === n
            ? (m(p.rgba.props, function (t, e) {
                s[e.idx] = W(o[e.idx], e);
              }),
              this)
            : "object" === n
                ...
                o instanceof h
                  ...
                  : function (t, i) {
                      ...
                      m(i.props, function (t, e) {
                        ...
                        r[n] &&
                          l.inArray(null, r[n].slice(0, 3)) < 0 &&
                          ((r[n][3] = 1), i.from && (r._rgba = i.from(r[n])));
                    }
              ),
              this)
            : void 0
    ...
    (p.hsla.from = function (t) {
      ...
      var e = t[0] / 360,
        ...
        n = 2 * n - i;
      return [
        Math.round(255 * B(n, i, e + 1 / 3)),
        Math.round(255 * B(n, i, e)),
        Math.round(255 * B(n, i, e - 1 / 3)),
        t,
      ];
    }),
    m(p, function (f, t) {
      var r = t.props,
        ...
        c = t.from;
      (h.fn[f] = function (t) {
        if ((a && !this[s] && (this[s] = a(this._rgba)), t === u))
          return this[s].slice();
        var e,
          i = l.type(t),
        ...
        m(r, function (s, a) {
          h.fn[s] ||
            (h.fn[s] = function (t) {
              ...
              return "undefined" === i
                ? r
                : ("function" === i && ((t = t.call(this, r)), (i = l.type(t))),
                  null == t && a.empty
                    ? this
                    : ("string" === i &&
                        (e = d.exec(t)) &&
                        (t = r + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
                      (o[a.idx] = t),
                      this[n](o)));
            });
        });
          ...
          set: function (t, e) {
            ...
            if ("transparent" !== e && ("string" !== l.type(e) || (i = q(e)))) {
              if (((e = h(i || e)), !s.rgba && 1 !== e._rgba[3])) {
                for (
                  n = "backgroundColor" === r ? t.parentNode : t;
      ...
      function (t, e) {
        b.fx.step[e] = function (t) {
          (("none" !== t.end && !t.setAttr) || (1 === t.pos && !t.setAttr)) &&
            (k.style(t.elem, e, t.end), (t.setAttr = !0));
        };
      }
    ),
    b.fn.addBack ||
      (b.fn.addBack = function (t) {
        return this.add(
              ...
              (this.diff = (function (t, e) {
                ...
                for (i in e)
                  (n = e[i]),
                    t[i] !== n &&
                      (y[i] ||
                        (!b.fx.step[i] && isNaN(parseFloat(n))) ||
                        (o[i] = n));
                return o;
              })(this.start, this.end)),
              this
    ...
    b.fn.extend({
      addClass:
        ...
        function (t, e, i, n) {
          return e
            ? b.effects.animateClass.call(this, { add: t }, e, i, n)
      ...
      removeClass:
        ...
        function (t, e, i, n) {
          return 1 < arguments.length
            ? b.effects.animateClass.call(this, { remove: t }, e, i, n)
      ...
      toggleClass:
        ...
        function (t, e, i, n, o) {
          return "boolean" == typeof e || void 0 === e
            ...
            : b.effects.animateClass.call(this, { toggle: t }, e, i, n);
        }),
      ...
      b.extend(b.effects, {
        ...
        restore: function (t, e) {
          for (var i, n = 0, o = e.length; n < o; n++)
            null !== e[n] && ((i = t.data(w + e[n])), t.css(e[n], i));
        },
    ...
    b.fn.extend({
      ...
      transfer: function (t, e) {
        var i = b(this),
          ...
          n = i.offset(),
          f = b("<div class='ui-effects-transfer'></div>")
            .appendTo("body")
  ...
  b.effects.define("blind", "hide", function (t, e) {
    ...
    (s.clip[i[o][0]] = s.clip[i[o][1]]),
      "show" === t.mode &&
        (n.cssClip(s.clip), a && a.css(b.effects.clipToBox(s)), (s.clip = r)),
    ...
    b.effects.define("bounce", function (t, e) {
      ...
      for (
        ...
        ((i = {})[h] = (p ? "-=" : "+=") + c),
          ...
          (c = s ? 2 * c : c / 2);
      s &&
        (((i = { opacity: 0 })[h] = (p ? "-=" : "+=") + c), o.animate(i, u, d)),
        o.queue(e),
    ...
    b.effects.define("clip", "hide", function (t, e) {
      ...
      (i.clip = {
        ...
        "show" === t.mode && (n.cssClip(i.clip), (i.clip = o)),
        n.animate(i, {
          queue: !1,
          duration: t.duration,
          easing: t.easing,
    ...
    b.effects.define("drop", "hide", function (t, e) {
      ...
      b.effects.createPlaceholder(i),
        (o =
          t.distance || i["top" == r ? "outerHeight" : "outerWidth"](!0) / 2),
        (f[r] = s + o),
        n && (i.css(f), (f[r] = a + o), (f.opacity = 1)),
        i.animate(f, {
          queue: !1,
          duration: t.duration,
          easing: t.easing,
    ...
    b.effects.define("explode", "hide", function (t, e) {
      ...
      function m() {
        g.push(this),
          g.length === f * c &&
            (l.css({ visibility: "visible" }), b(g).remove(), e());
      }
      for (i = 0; i < f; i++)
        for (r = d.top + i * p, a = i - (f - 1) / 2, n = 0; n < c; n++)
          (o = d.left + n * h),
            (s = n - (c - 1) / 2),
            l
              .clone()
    ...
    b.effects.define("fold", "hide", function (e, t) {
      ...
      a && (s = (parseInt(a[1], 10) / 100) * p[r ? 0 : 1]),
        ...
        (h.clip[f[1]] = 0),
        o &&
          (i.cssClip(h.clip), l && l.css(b.effects.clipToBox(h)), (h.clip = u)),
        i
          .queue(function (t) {
            l &&
              l
                .animate(b.effects.clipToBox(d), c, e.easing)
                .animate(b.effects.clipToBox(h), c, e.easing),
              t();
          })
          .animate(d, c, e.easing)
          .animate(h, c, e.easing)
          .queue(t),
    ...
    b.effects.define("size", function (n, e) {
      ...
      b.effects.createPlaceholder(i),
        "show" === a && ((a = p), (p = g), (g = a)),
        (o = {
          from: { y: p.height / h.height, x: p.width / h.width },
          to: { y: g.height / h.height, x: g.width / h.width },
        }),
        ("box" !== c && "both" !== c) ||
          (o.from.y !== o.to.y &&
            ((p = b.effects.setTransition(i, r, o.from.y, p)),
            (g = b.effects.setTransition(i, r, o.to.y, g))),
          o.from.x !== o.to.x &&
            ((p = b.effects.setTransition(i, s, o.from.x, p)),
            (g = b.effects.setTransition(i, s, o.to.x, g)))),
        ("content" !== c && "both" !== c) ||
          (o.from.y !== o.to.y &&
            ((p = b.effects.setTransition(i, t, o.from.y, p)),
            (g = b.effects.setTransition(i, t, o.to.y, g)))),
        l &&
          ((l = b.effects.getBaseline(l, h)),
        ...
        i.css(p),
        ("content" !== c && "both" !== c) ||
          ((r = r.concat(["marginTop", "marginBottom"]).concat(t)),
          ...
          i.find("*[width]").each(function () {
            ...
            o.from.y !== o.to.y &&
              ((i = b.effects.setTransition(t, r, o.from.y, i)),
              (e = b.effects.setTransition(t, r, o.to.y, e))),
              o.from.x !== o.to.x &&
                ((i = b.effects.setTransition(t, s, o.from.x, i)),
    ...
    b.effects.define("pulsate", "show", function (t, e) {
      var i = b(this),
        ...
        n = i.queue().length;
      for (
        (!o && i.is(":visible")) || (i.css("opacity", 0).show(), (a = 1));
        f < r;
        f++
      )
        i.animate({ opacity: a }, s, t.easing), (a = 1 - a);
      i.animate({ opacity: a }, s, t.easing),
        i.queue(e),
    ...
    b.effects.define("slide", "show", function (t, e) {
      ...
      b.effects.createPlaceholder(o),
        ...
        "show" === s &&
          (o.cssClip(u.clip), o.css(f, u[f]), (u.clip = i), (u[f] = n)),
        o.animate(u, {
          queue: !1,
          duration: t.duration,
          easing: t.easing,
  ...
  !1 !== b.uiBackCompat &&
    (I = b.effects.define("transfer", function (t, e) {
      b(this).transfer(t, e);
    }));
});
...
!(function (e) {
  ...
  function m() {
    ...
    (i.hastransform = !!i.trstyle),
      i.hastransform &&
        ((r[i.trstyle] = "translate3d(1px,2px,3px)"),
    ...
    return (
      i.ischrome26 && (i.prefixstyle = l[1]),
      ...
      (i.cursorgrabvalue = (function () {
        ...
        for (var o = 0; o < e.length; o++) {
          var t = e[o];
          if (((r.cursor = t), r.cursor == t)) return t;
        }
  ...
  function i(e, o) {
    ...
    if (
      ...
      (this.me = o),
      (this.opt = { doc: x("body"), win: !1 }),
      x.extend(this.opt, z),
      (this.opt.snapbackspeed = 80),
      e)
    )
      for (var t in g.opt) void 0 !== e[t] && (g.opt[t] = e[t]);
    for (
      this.doc = g.opt.doc,
        ...
        this.observerbody = !1;
      (this.id = "ascrail" + u++), document.getElementById(this.id);
    ...
    (this.canhwscroll = f.hastransform && g.opt.hwacceleration),
      ...
      !f.cantouch ||
        f.isios ||
        f.isandroid ||
        (!f.iswebkit && !f.ismozilla) ||
        ((this.istouchcapable = !0), (f.cantouch = !1)),
      g.opt.enablemouselockapi ||
        ((f.hasmousecapture = !1), (f.haspointerlock = !1));
    var r,
      i = !(this.debounced = function (o, e, t) {
        var r = g.delaylist[o];
        (g.delaylist[o] = e),
          r ||
            setTimeout(function () {
              var e = g.delaylist[o];
              (g.delaylist[o] = !1), e.call(g);
            }, t);
      });
    ...
    (this.synched = function (e, o) {
      return (
        ...
        i ||
          (h(function () {
            for (var e in ((i = !1), g.synclist)) {
              var o = g.synclist[e];
              o && o.call(g), (g.synclist[e] = !1);
            }
          }),
          (i = !0)),
        e
      ...
      (this.css = function (e, o) {
        for (var t in o) g.saved.css.push([e, t, e.css(t)]), e.css(t, o[t]);
      }),
      ...
      this.ishwscroll
        ? ((this.doc.translate = { x: 0, y: 0, tx: "0px", ty: "0px" }),
          ...
          f.hastranslate3d && g.opt.enabletranslate3d
        ...
        : ((this.getScrollTop = function () {
          ...
          (this.getScrollLeft = function () {
            return g.detected.ismozilla && g.isrtlmode
              ? Math.abs(g.docscroll.scrollLeft())
              : g.docscroll.scrollLeft();
          }),
          (this.setScrollLeft = function (e) {
            return g.docscroll.scrollLeft(
              g.detected.ismozilla && g.isrtlmode ? -e : e
            );
          })),
    ...
    function l(e, o, t) {
      (e = e.css(o)), (o = parseFloat(e));
      if (isNaN(o)) {
        t =
          3 == (o = s[e] || 0)
            ? t
              ? g.win.outerHeight() - g.win.innerHeight()
              : g.win.outerWidth() - g.win.innerWidth()
            : 1;
        return g.isie8 && o && (o += 1), t ? o : 0;
      }
      return o;
    }
    function a(t, r, i, e) {
    ...
    function d(e, o, t) {
      ...
      if (
        (0 == e.deltaMode
          ? ((r = -Math.floor(e.deltaX * (g.opt.mousescrollstep / 54))),
            (i = -Math.floor(e.deltaY * (g.opt.mousescrollstep / 54))))
          : 1 == e.deltaMode &&
            ((r = -Math.floor(e.deltaX * g.opt.mousescrollstep)),
            (i = -Math.floor(e.deltaY * g.opt.mousescrollstep))),
        o &&
          g.opt.oneaxismousemode &&
          0 == r &&
          i &&
          ((r = i),
          (i = 0),
        ...
        r &&
          ...
          g.debounced(
            ...
            function () {
              var e = g.lastdeltax;
              (g.lastdeltax = 0), g.rail.drag || g.doScrollLeftBy(e);
            },
            15
          )),
        i)
        ...
        g.scrollmom && g.scrollmom.stop(),
          ...
          g.debounced(
            ...
            function () {
              var e = g.lastdeltay;
              (g.lastdeltay = 0), g.rail.drag || g.doScrollBy(e);
            },
            15
          );
      }
    ...
    (this.getDocumentScrollOffset = function () {
      ...
      (this.getOffset = function () {
        ...
        o = g.win.offset();
        if (!g.viewport) return o;
        e = g.viewport.offset();
        return { top: o.top - e.top, left: o.left - e.left };
      }),
      (this.updateScrollBar = function (e) {
        ...
        g.ishwscroll
          ? (g.rail.css({
              height:
                g.win.innerHeight() -
                (g.opt.railpadding.top + g.opt.railpadding.bottom),
            }),
            g.railh &&
              g.railh.css({
                width:
                  g.win.innerWidth() -
                  (g.opt.railpadding.left + g.opt.railpadding.right),
              }))
          : (((r = {
            ...
            (r.left += g.rail.align
              ? g.win.outerWidth() -
                l(g.win, "border-right-width") -
                g.rail.width
              : l(g.win, "border-left-width")),
            (t = g.opt.railoffset) &&
              (t.top && (r.top += t.top),
            ...
            g.zoom &&
              g.zoom.css({
                top: r.top + 1,
                left:
                  1 == g.rail.align ? r.left - 20 : r.left + g.rail.width + 4,
              }),
            g.railh &&
              !g.railslocked &&
              ((r = { top: o.top, left: o.left }),
              (t = g.opt.railhoffset) &&
                (t.top && (r.top += t.top), t.left && (r.left += t.left)),
              (t = g.railh.align
                ? r.top +
                  l(g.win, "border-top-width", !0) +
                  g.win.innerHeight() -
                  g.railh.height
                : r.top + l(g.win, "border-top-width", !0)),
      ...
      (this.doRailClick = function (e, o, t) {
        ...
        g.railslocked ||
          (g.cancelEvent(e),
          o
            ? (r = t ? g.doScrollLeft : g.doScrollTop)(
                (i = t
                  ? (e.pageX - g.railh.offset().left - g.cursorwidth / 2) *
                    g.scrollratio.x
                  : (e.pageY - g.rail.offset().top - g.cursorheight / 2) *
                    g.scrollratio.y)
              )
            : ((r = t ? g.doScrollLeftBy : g.doScrollBy),
              (i = t ? g.scroll.x : g.scroll.y),
              (e = t
                ? e.pageX - g.railh.offset().left
                : e.pageY - g.rail.offset().top),
      ...
      g.hasanimationframe
        ...
        : ((h = function (e) {
          ...
          (p = clearInterval)),
      (this.init = function () {
        if (((g.saved.css = []), f.isie7mobile)) return !0;
        if (f.isoperamini) return !0;
        if (
          (f.hasmstouch &&
            g.css(g.ispage ? x("html") : g.win, { "-ms-touch-action": "none" }),
          (g.zindex = "auto"),
          g.ispage || "auto" != g.opt.zindex
            ? (g.zindex = g.opt.zindex)
            : (g.zindex =
                (function () {
                  var e = g.win;
          ...
          g.ispage && (e = g.haswrapper ? g.win : g.doc),
            f.isie9mobile || g.css(e, { "overflow-y": "hidden" }),
            g.ispage &&
              f.isie7 &&
              ("BODY" == g.doc[0].nodeName
                ? g.css(x("html"), { "overflow-y": "hidden" })
                : "HTML" == g.doc[0].nodeName &&
                  g.css(x("body"), { "overflow-y": "hidden" })),
            !f.isios ||
              g.ispage ||
              g.haswrapper ||
              g.css(x("body"), { "-webkit-overflow-scrolling": "touch" });
          ...
          for (n in s)
            (i = s[n]),
              (r = g.opt.railpadding[i])
                ? t.css("padding-" + i, r + "px")
                : (g.opt.railpadding[i] = 0);
          t.append(o),
          ...
          !g.opt.boxzoom ||
            ...
            f.cantouch &&
              g.opt.gesturezoom &&
              ((g.ongesturezoom = function (e) {
                return (
                  1.5 < e.scale && g.doZoomIn(e),
                  e.scale < 0.8 && g.doZoomOut(e),
                  g.cancelEvent(e)
                );
              }),
            ...
            g.opt.horizrailenabled &&
              ...
              f.isieold && o.css({ overflow: "hidden" }),
            ...
            g.ispage
              ? (t.css({ position: "fixed", top: "0px", height: "100%" }),
                ...
                g.body.append(t),
                g.railh &&
                  (a.css({ position: "fixed", left: "0px", width: "100%" }),
                  a.align ? a.css({ bottom: "0px" }) : a.css({ top: "0px" }),
                  g.body.append(a)))
              : (g.ishwscroll
                  ? ("static" == g.win.css("position") &&
                      g.css(g.win, { position: "relative" }),
                  ...
                  : ((g.isfixed = "fixed" == g.win.css("position")),
                    ...
                    g.viewport &&
                      ((g.body = g.viewport),
                      0 == /fixed|absolute/.test(g.viewport.css("position")) &&
                        g.css(g.viewport, { position: "relative" })),
                    t.css({ position: l }),
                    g.zoom && g.zoom.css({ position: l }),
                    g.updateScrollBar(),
                    g.body.append(t),
                    g.zoom && g.body.append(g.zoom),
                    g.railh && (a.css({ position: l }), g.body.append(a))),
                f.isios &&
                  g.css(g.win, {
                ...
                f.isie &&
                  g.opt.disableoutline &&
                  g.win.attr("hideFocus", "true"),
                f.iswebkit &&
                  g.opt.disableoutline &&
                  g.win.css({ outline: "none" })),
            !1 === g.opt.autohidemode
              ? ((g.autohidedom = !1),
                g.rail.css({ opacity: g.opt.cursoropacitymax }),
                g.railh && g.railh.css({ opacity: g.opt.cursoropacitymax }))
              : !0 === g.opt.autohidemode || "leave" === g.opt.autohidemode
              ? ((g.autohidedom = x().add(g.rail)),
                f.isie8 && (g.autohidedom = g.autohidedom.add(g.cursor)),
                g.railh && (g.autohidedom = g.autohidedom.add(g.railh)),
                g.railh &&
                  f.isie8 &&
                  (g.autohidedom = g.autohidedom.add(g.cursorh)))
              : "scroll" == g.opt.autohidemode
              ? ((g.autohidedom = x().add(g.rail)),
                g.railh && (g.autohidedom = g.autohidedom.add(g.railh)))
              : "cursor" == g.opt.autohidemode
              ? ((g.autohidedom = x().add(g.cursor)),
                g.railh && (g.autohidedom = g.autohidedom.add(g.cursorh)))
              : "hidden" == g.opt.autohidemode &&
                ((g.autohidedom = !1), g.hide(), (g.railslocked = !1)),
            f.isie9mobile
              ? ((g.scrollmom = new T(g)),
                (g.onmangotouch = function () {
                  var e = g.getScrollTop(),
                    o = g.getScrollLeft();
                  if (
                    e == g.scrollmom.lastscrolly &&
                    o == g.scrollmom.lastscrollx
                  )
                    return !0;
                  var t,
                    r,
                  ...
                  0 != Math.round(Math.sqrt(Math.pow(s, 2) + Math.pow(n, 2))) &&
                    ...
                    g.mangotouch.drx != r
                      ...
                      : (g.scrollmom.stop(),
                        ...
                        (g.mangotouch.tm = i),
                        (i = Math.max(
                          Math.abs(g.mangotouch.ly - e),
                          Math.abs(g.mangotouch.lx - o)
                        )),
                        (g.mangotouch.ly = e),
                        (g.mangotouch.lx = o),
                        2 < i &&
              ...
              : ((f.cantouch ||
                  ...
                  (g.ontouchstart = function (e) {
                    if (
                      ...
                      return !1;
                    if (((g.hasmoving = !1), !g.railslocked)) {
                      var o, t, r, i, n;
                      if (f.hasmstouch)
                        for (o = e.target || !1; o; ) {
                          var s = x(o).getNiceScroll();
                          if (0 < s.length && s[0].me == g.me) break;
                          if (0 < s.length) return !1;
                          if ("DIV" == o.nodeName && o.id == g.id) break;
                          o = o.parentNode || !1;
                        }
                      if ((g.cancelScroll(), (o = g.getTarget(e)), o))
                      ...
                      if (
                        ...
                        g.forcescreen &&
                          (((e = { original: (r = e).original || e }).clientX =
                            r.screenX),
                          (e.clientY = r.screenY)),
                        (g.rail.drag = {
                          x: e.clientX,
                        ...
                        g.ispage || !g.opt.directionlockdeadzone
                          ? (g.rail.drag.dl = "f")
                          : ((n = x(window).width()),
                            (i = x(window).height()),
                            (t = Math.max(
                            ...
                            (i = Math.max(0, r - i)),
                            (n = Math.max(0, t - n)),
                            !g.rail.scrollable && g.railh.scrollable
                              ? (g.rail.drag.ck = 0 < i && "v")
                              : g.rail.scrollable && !g.railh.scrollable
                              ? (g.rail.drag.ck = 0 < n && "h")
                              : (g.rail.drag.ck = !1),
                        ...
                        if (!(!!o && /INPUT|SELECT|TEXTAREA/i.test(o.nodeName)))
                          return (
                            !g.ispage && f.hasmousecapture && o.setCapture(),
                            g.opt.touchbehavior
                              ? (o.onclick &&
                                  !o._onclick &&
                                  ((o._onclick = o.onclick),
                                  (o.onclick = function (e) {
                                    if (g.hasmoving) return !1;
                                    o._onclick.call(this, e);
                                  })),
                                g.cancelEvent(e))
                              : g.stopPropagation(e)
                          );
                        /SUBMIT|CANCEL|BUTTON/i.test(x(o).attr("type")) &&
                          ((pc = { tg: o, click: !1 }), (g.preventclick = pc));
                      }
                    }
                  }),
                  ...
                  (g.ontouchmove = function (e, o) {
                    if (!g.rail.drag) return !1;
                    if (
                      e.targetTouches &&
                      g.opt.preventmultitouchscrolling &&
                    ...
                    (g.hasmoving = !0),
                      g.preventclick &&
                        !g.preventclick.click &&
                        ((g.preventclick.click =
                          g.preventclick.tg.onclick || !1),
                        (g.preventclick.tg.onclick = g.onpreventclick)),
                      "changedTouches" in (e = x.extend({ original: e }, e)) &&
                        ((e.clientX = e.changedTouches[0].clientX),
                        (e.clientY = e.changedTouches[0].clientY)),
                      g.forcescreen &&
                        (((e = { original: (a = e).original || e }).clientX =
                          a.screenX),
                        (e.clientY = a.screenY)),
                      (a = l = 0),
                      c &&
                        !o &&
                        ((a = -(n = g.win.position()).left), (l = -n.top));
                    var t,
                      r = e.clientY + l,
                      o = r - g.rail.drag.y,
                      i = e.clientX + a,
                    ...
                    g.ishwscroll && g.opt.bouncescroll
                      ? s < 0
                        ? (s = Math.round(s / 2))
                        : s > g.page.maxh &&
                          (s = g.page.maxh + Math.round((s - g.page.maxh) / 2))
                      : (s < 0 && (r = s = 0),
                        s > g.page.maxh && ((s = g.page.maxh), (r = 0))),
                      g.railh &&
                        g.railh.scrollable &&
                        ((t = g.isrtlmode
                          ? n - g.rail.drag.sl
                        ...
                        g.ishwscroll && g.opt.bouncescroll
                          ? t < 0
                            ...
                            : t > g.page.maxw &&
                              (t =
                                g.page.maxw + Math.round((t - g.page.maxw) / 2))
                          : (t < 0 && (i = t = 0),
                            t > g.page.maxw && ((t = g.page.maxw), (i = 0))));
                    var l = !1;
                    if (g.rail.drag.dl)
                      (l = !0),
                        "v" == g.rail.drag.dl
                          ? (t = g.rail.drag.sl)
                          : "h" == g.rail.drag.dl && (s = g.rail.drag.st);
                    else {
                      var a = Math.abs(o),
                        o = Math.abs(n),
                        n = g.opt.directionlockdeadzone;
                      if ("v" == g.rail.drag.ck) {
                        if (n < a && o <= 0.3 * a) return !(g.rail.drag = !1);
                        n < o &&
                          ((g.rail.drag.dl = "f"),
                          x("body").scrollTop(x("body").scrollTop()));
                      } else if ("h" == g.rail.drag.ck) {
                        if (n < o && a <= 0.3 * o) return !(g.rail.drag = !1);
                        n < a &&
                          ((g.rail.drag.dl = "f"),
                      ...
                      g.synched("touchmove", function () {
                        g.rail.drag &&
                          ...
                          g.railh && g.railh.scrollable
                            ? (g.setScrollLeft(t), g.showCursor(s, t))
                            : g.showCursor(s),
                ...
                (g.onmousedown = function (e, o) {
                  if (!g.rail.drag || 1 == g.rail.drag.pt) {
                    if (g.railslocked) return g.cancelEvent(e);
                    g.cancelScroll(),
                      (g.rail.drag = {
                        x: e.clientX,
                        y: e.clientY,
                    ...
                    return (
                      ...
                      g.isiframe &&
                        !f.hasmousecapture &&
                        ((g.saved.csspointerevents =
                          g.doc.css("pointer-events")),
                        g.css(g.doc, { "pointer-events": "none" })),
                      (g.hasmoving = !1),
                      g.cancelEvent(e)
                    );
                  }
                ...
                (g.onmouseup = function (e) {
                  if (g.rail.drag)
                    return (
                      ...
                      g.isiframe &&
                        !f.hasmousecapture &&
                        g.doc.css("pointer-events", g.saved.csspointerevents),
                      (g.rail.drag = !1),
                ...
                (g.onmousemove = function (e) {
                  var o;
                  if (g.rail.drag && 1 == g.rail.drag.pt)
                    return f.ischrome && 0 == e.which
                      ? g.onmouseup(e)
                      : ((g.cursorfreezed = !0),
                        (g.hasmoving = !0),
                        g.rail.drag.hr
                          ? ((g.scroll.x =
                              g.rail.drag.sx + (e.clientX - g.rail.drag.x)),
                            g.scroll.x < 0 && (g.scroll.x = 0),
                            (o = g.scrollvaluemaxw),
                            g.scroll.x > o && (g.scroll.x = o))
                          : ((g.scroll.y =
                              g.rail.drag.sy + (e.clientY - g.rail.drag.y)),
                          ...
                          g.rail.drag &&
                            ...
                            g.rail.drag.hr
                              ? g.hasreversehr
                                ? g.doScrollLeft(
                                    g.scrollvaluemaxw -
                                      Math.round(g.scroll.x * g.scrollratio.x),
                                    g.opt.cursordragspeed
                                  )
                                : g.doScrollLeft(
                                    Math.round(g.scroll.x * g.scrollratio.x),
                                    g.opt.cursordragspeed
                              ...
                              : g.doScrollTop(
                                  Math.round(g.scroll.y * g.scrollratio.y),
                                  g.opt.cursordragspeed
                                ));
                        }),
                        g.cancelEvent(e));
                }),
                f.cantouch || g.opt.touchbehavior
                  ? ((g.onpreventclick = function (e) {
                      if (g.preventclick)
                        return (
                          (g.preventclick.tg.onclick = g.preventclick.click),
                          (g.preventclick = !1),
                          g.cancelEvent(e)
                        );
                    }),
                    ...
                    (g.onclick =
                      ...
                      function (e) {
                        return (
                          !g.lastmouseup ||
                          ((g.lastmouseup = !1), g.cancelEvent(e))
                        );
                      }),
                    g.opt.grabcursorenabled &&
                      f.cursorgrabvalue &&
                      (g.css(g.ispage ? g.doc : g.win, {
                        cursor: f.cursorgrabvalue,
                      }),
                      g.css(g.rail, { cursor: f.cursorgrabvalue })))
                  : ((d = function (e) {
                      var o, t;
                      g.selectiondrag &&
                        (e &&
                          ((o = g.win.outerHeight()),
                          0 < (t = e.pageY - g.selectiondrag.top) &&
                            t < o &&
                            (t = 0),
                          o <= t && (t -= o),
                          (g.selectiondrag.df = t)),
                        0 != g.selectiondrag.df &&
                          ((t = 2 * -Math.floor(g.selectiondrag.df / 6)),
                          g.doScrollBy(t),
                          g.debounced(
                            "doselectionscroll",
                            function () {
                ...
                f.hasw3ctouch
                  ? (g.css(g.rail, { "touch-action": "none" }),
                    g.css(g.cursor, { "touch-action": "none" }),
                    g.bind(g.win, "pointerdown", g.ontouchstart),
                    g.bind(document, "pointerup", g.ontouchend),
                    g.bind(document, "pointermove", g.ontouchmove))
                  : f.hasmstouch
                  ...
                  : this.istouchcapable &&
                    (g.bind(g.win, "touchstart", g.ontouchstart),
                ...
                (!g.opt.cursordragontouch &&
                  ...
                  g.opt.sensitiverail &&
                    (g.bind(g.rail, "click", function (e) {
                      g.doRailClick(e, !1, !1);
                    }),
                  ...
                  g.railh &&
                    ...
                    g.opt.sensitiverail &&
                      (g.bind(g.railh, "click", function (e) {
                        g.doRailClick(e, !1, !0);
                      }),
                ...
                f.cantouch || g.opt.touchbehavior
                  ? (g.bind(
                      f.hasmousecapture ? g.win : document,
                      "mouseup",
                      g.ontouchend
                    ),
                    ...
                    g.opt.cursordragontouch &&
                      ...
                      g.cursorh &&
                        g.bind(g.cursorh, "mousedown", function (e) {
                          g.onmousedown(e, !0);
                        }),
                      g.cursorh && g.bind(g.cursorh, "mouseup", g.onmouseup)))
                  : (g.bind(
                      f.hasmousecapture ? g.win : document,
                      "mouseup",
                      g.onmouseup
                    ...
                    !g.ispage &&
                      ...
                      g.cursorh &&
                        g.bind(g.cursorh, "mouseup", g.onselectionend),
                ...
                g.opt.enablemousewheel &&
                  (g.isiframe ||
                    g.bind(
                      f.isie && g.ispage ? document : g.win,
                      "mousewheel",
                      g.onmousewheel
                    ),
                ...
                g.ispage ||
                  ...
                  (g.win.attr("tabindex") || g.win.attr({ tabindex: b++ }),
            ...
            (g.onkeypress = function (e) {
              ...
              if (
                ...
                return !0;
              if (x(o).attr("contenteditable")) return !0;
              if (
                g.hasfocus ||
                (g.hasmousefocus && !w) ||
                (g.ispage && !w && !v)
                ...
                o = e.keyCode;
                if (g.railslocked && 27 != o) return g.cancelEvent(e);
                var t = e.ctrlKey || !1,
                  r = e.shiftKey || !1,
                  i = !1;
                switch (o) {
                  ...
                  case 63232:
                    g.railh &&
                      (t ? g.doScrollLeft(0) : g.doScrollLeftBy(72), (i = !0));
                    break;
                  case 39:
                  case 63234:
                    g.railh &&
                      (t ? g.doScrollLeft(g.page.maxw) : g.doScrollLeftBy(-72),
                      (i = !0));
                    break;
                  case 33:
                  case 63276:
                    g.doScrollBy(g.view.h), (i = !0);
                    break;
                  case 34:
                  case 63277:
                    g.doScrollBy(-g.view.h), (i = !0);
                  ...
                  case 63275:
                    g.railh && t
                      ? g.doScrollPos(g.page.maxw, g.page.maxh)
                      : g.doScrollTo(g.page.maxh),
                      (i = !0);
                    break;
                  case 32:
                    g.opt.spacebarenabled &&
                      (r ? g.doScrollBy(g.view.h) : g.doScrollBy(-g.view.h),
                      (i = !0));
                    break;
                  case 27:
                    g.zoomactive && (g.doZoom(), (i = !0));
                }
                return i ? g.cancelEvent(e) : void 0;
              }
            }),
            g.opt.enablekeyboard &&
              g.bind(
                document,
            ...
            !(g.onAttributeChange = function (e) {
              ...
              ((g.observerbody = new S(function (e) {
                if (
                  (e.forEach(function (e) {
                    if ("attributes" == e.type)
                      return x("body").hasClass("modal-open")
                        ? g.hide()
                        : g.show();
                  }),
            ...
            !g.ispage &&
              g.opt.boxzoom &&
              g.bind(window, "resize", g.resizeZoom),
            ...
            (g.forcescreen = !0),
              g.isiframe &&
                ...
                (g.getContentSize = function () {
                  return {
                    w: Math.max(
                      g.iframe.html.scrollWidth,
                      g.iframe.body.scrollWidth
                    ),
                    h: Math.max(
                      g.iframe.html.scrollHeight,
                      g.iframe.body.scrollHeight
                    ),
                  };
                }),
                (g.docscroll = x(g.iframe.body))),
              f.isios ||
                !g.opt.iframeautoresize ||
                g.isiframe ||
                (g.win.scrollTop(0),
                g.doc.height(""),
                (e = Math.max(
                ...
                g.doc.height(e)),
              g.lazyResize(30),
              f.isie7 && g.css(x(g.iframe.html), { "overflow-y": "hidden" }),
              g.css(x(g.iframe.body), { "overflow-y": "hidden" }),
              f.isios &&
                g.haswrapper &&
                g.css(x(o.body), { "-webkit-transform": "translate3d(0,0,0)" }),
              "contentWindow" in this
                ? g.bind(this.contentWindow, "scroll", g.onscroll)
                : g.bind(o, "scroll", g.onscroll),
              g.opt.enablemousewheel && g.bind(o, "mousewheel", g.onmousewheel),
              g.opt.enablekeyboard &&
                g.bind(o, f.isopera ? "keypress" : "keydown", g.onkeypress),
              (f.cantouch || g.opt.touchbehavior) &&
                (g.bind(o, "mousedown", g.ontouchstart),
                g.bind(o, "mousemove", function (e) {
                  return g.ontouchmove(e, !0);
                }),
                g.opt.grabcursorenabled &&
                  f.cursorgrabvalue &&
                  g.css(x(o.body), { cursor: f.cursorgrabvalue })),
              g.bind(o, "mouseup", g.ontouchend),
              g.zoom &&
                (g.opt.dblclickzoom && g.bind(o, "dblclick", g.doZoom),
      ...
      (this.showCursor = function (e, o) {
        g.cursortimeout &&
          (clearTimeout(g.cursortimeout), (g.cursortimeout = 0)),
          g.rail &&
            (g.autohidedom &&
              (g.autohidedom.stop().css({ opacity: g.opt.cursoropacitymax }),
              (g.cursoractive = !0)),
            (g.rail.drag && 1 == g.rail.drag.pt) ||
              (void 0 !== e &&
                !1 !== e &&
                (g.scroll.y = Math.round(+e / g.scrollratio.y)),
              void 0 !== o && (g.scroll.x = Math.round(+o / g.scrollratio.x))),
            g.cursor.css({ height: g.cursorheight, top: g.scroll.y }),
            g.cursorh &&
              ((o = g.hasreversehr
                ? g.scrollvaluemaxw - g.scroll.x
                : g.scroll.x),
              !g.rail.align && g.rail.visibility
                ? g.cursorh.css({
                    width: g.cursorwidth,
                    left: o + g.rail.width,
                  })
                : g.cursorh.css({ width: g.cursorwidth, left: o }),
              (g.cursoractive = !0)),
      ...
      (this.hideCursor = function (e) {
        g.cursortimeout ||
          (g.rail &&
            g.autohidedom &&
            ((g.hasmousefocus && "leave" == g.opt.autohidemode) ||
              (g.cursortimeout = setTimeout(function () {
                (g.rail.active && g.showonmouseevent) ||
                  (g.autohidedom
                    .stop()
                    .animate({ opacity: g.opt.cursoropacitymin }),
                  g.zoom &&
                    g.zoom.stop().animate({ opacity: g.opt.cursoropacitymin }),
                  (g.cursoractive = !1)),
                  (g.cursortimeout = 0);
              }, e || g.opt.hidecursordelay))));
      }),
      (this.noticeCursor = function (e, o, t) {
        g.showCursor(o, t), g.rail.active || g.hideCursor(e);
      }),
      (this.getContentSize = g.ispage
        ...
        ? function () {
            return {
              w:
                g.doc.outerWidth() +
                parseInt(g.win.css("paddingLeft")) +
                parseInt(g.win.css("paddingRight")),
              h:
                g.doc.outerHeight() +
                parseInt(g.win.css("paddingTop")) +
                parseInt(g.win.css("paddingBottom")),
            };
          }
        : function () {
            return {
      ...
      (this.onResize = function (e, o) {
        ...
        if (!g.haswrapper && !g.ispage) {
          if ("none" == g.win.css("display"))
            return g.visibility && g.hideRail().hideRailHr(), !1;
        ...
        if (
          ...
          if (g.lastposition) {
            i = g.lastposition;
            if (i.top == n.top && i.left == n.left) return g;
          }
          g.lastposition = n;
        }
        return (
          ...
          0 == g.page.maxw
            ? (g.hideRailHr(),
              ...
              (g.cursorwidth = 0),
              g.setScrollLeft(0),
              (g.railh.scrollable = !1))
            : ((g.page.maxw -=
                g.opt.railpadding.left + g.opt.railpadding.right),
              (g.railh.scrollable = !0)),
          (g.railslocked = g.locked || (0 == g.page.maxh && 0 == g.page.maxw)),
          g.railslocked
            ? (g.ispage || g.updateScrollBar(g.view), !1)
            : (g.hidden || g.visibility
                ? g.hidden || g.railh.visibility || g.showRailHr()
                : g.showRail().showRailHr(),
              g.istextarea &&
                g.win.css("resize") &&
                "none" != g.win.css("resize") &&
                (g.view.h -= 20),
              (g.cursorheight = Math.min(
                g.view.h,
                Math.round(g.view.h * (g.view.h / g.page.h))
              )),
              (g.cursorheight =
                g.opt.cursorfixedheight ||
                Math.max(g.opt.cursorminheight, g.cursorheight)),
              (g.cursorwidth = Math.min(
                g.view.w,
                Math.round(g.view.w * (g.view.w / g.page.w))
              )),
              (g.cursorwidth =
                g.opt.cursorfixedheight ||
                Math.max(g.opt.cursorminheight, g.cursorwidth)),
              (g.scrollvaluemax =
                g.view.h -
                g.cursorheight -
                g.cursor.hborder -
              ...
              g.railh &&
                ((g.railh.width =
                  0 < g.page.maxh ? g.view.w - g.rail.width : g.view.w),
                (g.scrollvaluemaxw =
                  g.railh.width -
                  g.cursorwidth -
                  g.cursorh.wborder -
              ...
              g.getScrollTop() > g.page.maxh
                ? g.doScrollTop(g.page.maxh)
                : ((g.scroll.y = Math.round(
                    g.getScrollTop() * (1 / g.scrollratio.y)
                  )),
                  (g.scroll.x = Math.round(
                    g.getScrollLeft() * (1 / g.scrollratio.x)
                  )),
                  g.cursoractive && g.noticeCursor()),
              g.scroll.y &&
                0 == g.getScrollTop() &&
                g.doScrollTo(Math.floor(g.scroll.y * g.scrollratio.y)),
              g)
        );
      }),
      (this.resize = g.onResize),
      (this.lazyResize = function (e) {
        return (e = isNaN(e) ? 30 : e), g.debounced("resize", g.resize, e), g;
      }),
      (this.jqbind = function (e, o, t) {
        g.events.push({ e: e, n: o, f: t, q: !0 }), x(e).bind(o, t);
      }),
      (this.bind = function (e, o, t, r) {
        ...
        "mousewheel" == o
          ? window.addEventListener || "onwheel" in document
            ? g._bind(n, "wheel", t, r || !1)
            : ((i =
                void 0 !== document.onmousewheel
                  ? "mousewheel"
                  : "DOMMouseScroll"),
              a(n, i, t, r || !1),
              "DOMMouseScroll" == i && a(n, "MozMousePixelScroll", t, r || !1))
          : n.addEventListener
          ? (f.cantouch &&
              /mouseup|mousedown|mousemove/.test(o) &&
              ((i =
                "mousedown" == o
                  ? "touchstart"
                  : "mouseup" == o
              ...
              g._bind(
                ...
                function (e) {
                  ...
                  e.touches
                    ? e.touches.length < 2 &&
                      (((o = e.touches.length ? e.touches[0] : e).original = e),
                      t.call(this, o))
                    : e.changedTouches &&
                      (((o = e.changedTouches[0]).original = e),
                      t.call(this, o));
                },
                r || !1
              )),
            ...
            f.cantouch &&
              "mouseup" == o &&
              g._bind(n, "touchcancel", t, r || !1))
          : g._bind(n, o, function (e) {
              return (
                (e = e || window.event || !1) &&
                  e.srcElement &&
      ...
      f.haseventlistener
        ? ((this._bind = function (e, o, t, r) {
            g.events.push({ e: e, n: o, f: t, b: r, q: !1 }),
              e.addEventListener(o, t, r || !1);
          }),
          (this.cancelEvent = function (e) {
            return (
              e &&
                ((e = e.original || e).preventDefault(),
                e.stopPropagation(),
      ...
      (this.showRail = function () {
        return (
          0 == g.page.maxh ||
            (!g.ispage && "none" == g.win.css("display")) ||
            ((g.visibility = !0),
            (g.rail.visibility = !0),
      ...
      (this.showRailHr = function () {
        return (
          g.railh &&
            (0 == g.page.maxw ||
              (!g.ispage && "none" == g.win.css("display")) ||
              ((g.railh.visibility = !0), g.railh.css("display", "block"))),
          g
        );
      }),
      ...
      (this.hideRailHr = function () {
        return (
          g.railh &&
            ((g.railh.visibility = !1), g.railh.css("display", "none")),
          g
        );
      }),
      (this.show = function () {
        return (g.hidden = !1), (g.railslocked = !1), g.showRail().showRailHr();
      }),
      (this.hide = function () {
        return (g.hidden = !0), (g.railslocked = !0), g.hideRail().hideRailHr();
      }),
      ...
      (this.remove = function () {
        g.stop(),
          ...
          g.unbindAll(),
          f.isie9 &&
            g.win[0].detachEvent("onpropertychange", g.onAttributeChange),
      ...
      (this.scrollstart = function (e) {
        return (this.onscrollstart = e), g;
      }),
      (this.scrollend = function (e) {
        return (this.onscrollend = e), g;
      }),
      (this.scrollcancel = function (e) {
        return (this.onscrollcancel = e), g;
      }),
      (this.zoomin = function (e) {
        return (this.onzoomin = e), g;
      }),
      (this.zoomout = function (e) {
        return (this.onzoomout = e), g;
      }),
      ...
      (this.triggerScrollEnd = function () {
        ...
        g.onscrollend &&
          ((o = {
            type: "scrollend",
            current: { x: (e = g.getScrollLeft()), y: (o = g.getScrollTop()) },
            end: { x: e, y: o },
          }),
      ...
      (this.onmousewheel = function (e) {
        if (!g.wheelprevented) {
          if (g.railslocked)
            return g.debounced("checkunlock", g.resize, 250), !0;
          if (g.rail.drag) return g.cancelEvent(e);
          if (
            ("auto" == g.opt.oneaxismousemode &&
              0 != e.deltaX &&
              (g.opt.oneaxismousemode = !1),
          ...
          var o = +new Date(),
            t = !1;
          if (
            (g.opt.preservenativescrolling &&
              g.checkarea + 600 < o &&
              ((g.nativescrollingarea = g.isScrollable(e)), (t = !0)),
            (g.checkarea = o),
            g.nativescrollingarea)
          )
            return !0;
          t = d(e, !1, t);
          return t && (g.checkarea = 0), t;
        }
      }),
      (this.onmousewheelhr = function (e) {
        if (!g.wheelprevented) {
          if (g.railslocked || !g.railh.scrollable) return !0;
          if (g.rail.drag) return g.cancelEvent(e);
          var o = +new Date(),
            t = !1;
          return (
            ...
            (g.checkarea = o),
            !!g.nativescrollingarea ||
              (g.railslocked ? g.cancelEvent(e) : d(e, !0, t))
          );
        }
      }),
      (this.stop = function () {
      ...
      g.opt.smoothscroll
        ? g.ishwscroll &&
          ...
          ? ((this.prepareTransition = function (e, o) {
              ...
              return (
                (g.lasttransitionstyle && g.lasttransitionstyle == e) ||
                  ((g.lasttransitionstyle = e),
            ...
            (this.doScrollPos = function (i, n, e) {
              var o = g.getScrollTop(),
                t = g.getScrollLeft();
              return (
                ((g.newscrolly - o) * (n - o) < 0 ||
                  (g.newscrollx - t) * (i - t) < 0) &&
                  g.cancelScroll(),
                0 == g.opt.bouncescroll &&
                  (n < 0 ? (n = 0) : n > g.page.maxh && (n = g.page.maxh),
                  i < 0 ? (i = 0) : i > g.page.maxw && (i = g.page.maxw)),
                (!g.scrollrunning || i != g.newscrollx || n != g.newscrolly) &&
                  ((g.newscrolly = n),
                  (g.newscrollx = i),
                  ...
                  !g.timer &&
                    void (g.timer = setTimeout(function () {
                      var e = g.getScrollTop(),
                        o = g.getScrollLeft(),
                        t = {};
                      (t.x = i - o), (t.y = n - e), (t.px = o), (t.py = e);
                      var r = Math.round(
                          Math.sqrt(Math.pow(t.x, 2) + Math.pow(t.y, 2))
                        ),
                        t =
                          g.newscrollspeed && 1 < g.newscrollspeed
                            ? g.newscrollspeed
                            : g.getTransitionSpeed(r);
                      g.newscrollspeed &&
                        g.newscrollspeed <= 1 &&
                        (t *= g.newscrollspeed),
                        ...
                        g.timerscroll &&
                          g.timerscroll.tm &&
                          clearInterval(g.timerscroll.tm),
                        0 < t &&
                          (!g.scrollrunning &&
                            g.onscrollstart &&
                            ((r = {
                              ...
                              current: { x: o, y: e },
                              request: { x: i, y: n },
                              end: { x: g.newscrollx, y: g.newscrolly },
                              speed: t,
                            }),
                          ...
                          f.transitionend
                            ? g.scrollendtrapped ||
                              ...
                              g.bind(
                                g.doc,
                                f.transitionend,
                                g.onScrollTransitionEnd,
                                !1
                              ))
                            : (g.scrollendtrapped &&
                                clearTimeout(g.scrollendtrapped),
                              (g.scrollendtrapped = setTimeout(
                                g.onScrollTransitionEnd,
                                t
                              ))),
                          (o = o),
                          (g.timerscroll = {
                            bz: new c(e, g.newscrolly, t, 0, 0, 0.58, 1),
                            bh: new c(o, g.newscrollx, t, 0, 0, 0.58, 1),
                          }),
                          g.cursorfreezed ||
          ...
          : ((this.doScrollLeft = function (e, o) {
            ...
            (this.doScrollPos = function (e, o, t) {
              ...
              if (g.timer && g.newscrolly == o && g.newscrollx == e) return !0;
              g.timer && p(g.timer), (g.timer = 0);
              var r = g.getScrollTop(),
                i = g.getScrollLeft();
              ((g.newscrolly - r) * (o - r) < 0 ||
                (g.newscrollx - i) * (e - i) < 0) &&
                g.cancelScroll(),
                (g.newscrolly = o),
                (g.newscrollx = e),
                (g.bouncescroll && g.rail.visibility) ||
                  (g.newscrolly < 0
                    ? (g.newscrolly = 0)
                    : g.newscrolly > g.page.maxh &&
                      (g.newscrolly = g.page.maxh)),
                (g.bouncescroll && g.railh.visibility) ||
                  (g.newscrollx < 0
                    ? (g.newscrollx = 0)
                ...
                (g.dst.py = r);
              var n = Math.round(
                Math.sqrt(Math.pow(g.dst.x, 2) + Math.pow(g.dst.y, 2))
              );
              (g.dst.ax = g.dst.x / n), (g.dst.ay = g.dst.y / n);
              var s = 0,
                l = n;
              0 == g.dst.x
                ? ((s = r), (l = o), (g.dst.ay = 1), (g.dst.py = 0))
                : 0 == g.dst.y &&
                  ((s = i), (l = e), (g.dst.ax = 1), (g.dst.px = 0));
              var a,
              ...
              t && t <= 1 && (n *= t),
                (g.bzscroll =
                  0 < n &&
                  (g.bzscroll
                    ? g.bzscroll.update(l, n)
                    : new c(s, l, n, 0, 1, 0, 1))),
                g.timer ||
                  (((r == g.page.maxh && o >= g.page.maxh) ||
                    (i == g.page.maxw && e >= g.page.maxw)) &&
                    g.checkContentSize(),
                  (a = 1),
                  ...
                  (function e() {
                    ...
                    g.dst.ay
                      ? ((((i =
                          (r = g.bzscroll
                            ? g.dst.py + g.bzscroll.getNow() * g.dst.ay
                            : g.newscrolly) - n) < 0 &&
                          r < g.newscrolly) ||
                          (0 < i && r > g.newscrolly)) &&
                          (r = g.newscrolly),
                    ...
                    g.dst.ax
                      ? ((((i =
                          (n = g.bzscroll
                            ? g.dst.px + g.bzscroll.getNow() * g.dst.ax
                            : g.newscrollx) - o) < 0 &&
                          n < g.newscrollx) ||
                          (0 < i && n > g.newscrollx)) &&
                          (n = g.newscrollx),
                      ...
                      2 == t
                        ? ((g.timer = 0),
                          ...
                          r < 0
                            ? (r = 0)
                            : r > g.page.maxh && (r = g.page.maxh),
                          n < 0
                            ? (n = 0)
                            : n > g.page.maxw && (n = g.page.maxw),
                          n != g.newscrollx || r != g.newscrolly
                            ? g.doScrollPos(n, r)
                            : g.onscrollend && g.triggerScrollEnd())
                        : (g.timer = h(e) || 1);
                  })(),
                  ((r == g.page.maxh && r <= o) ||
                    (i == g.page.maxw && i <= e)) &&
          ...
          (this.doScrollPos = function (e, o, t) {
            ...
            i < 0 && (i = 0),
              g.synched("scroll", function () {
                g.setScrollTop(i), g.setScrollLeft(r);
              });
          }),
          (this.cancelScroll = function () {})),
      (this.doScrollBy = function (e, o) {
        var t = 0;
        (t = o
          ? Math.floor((g.scroll.y - e) * g.scrollratio.y)
          : (g.timer ? g.newscrolly : g.getScrollTop(!0)) - e),
          g.bouncescroll &&
            (t < -(r = Math.round(g.view.h / 2))
              ? (t = -r)
              : t > g.page.maxh + r && (t = g.page.maxh + r)),
          (g.cursorfreezed = !1);
        var r = g.getScrollTop(!0);
        return t < 0 && r <= 0
          ? g.noticeCursor()
          : t > g.page.maxh && r >= g.page.maxh
          ? (g.checkContentSize(), g.noticeCursor())
          : void g.doScrollTop(t);
      }),
      (this.doScrollLeftBy = function (e, o) {
        var t = 0;
        (t = o
          ? Math.floor((g.scroll.x - e) * g.scrollratio.x)
          : (g.timer ? g.newscrollx : g.getScrollLeft(!0)) - e),
          g.bouncescroll &&
            (t < -(r = Math.round(g.view.w / 2))
              ? (t = -r)
              : t > g.page.maxw + r && (t = g.page.maxw + r)),
          (g.cursorfreezed = !1);
        var r = g.getScrollLeft(!0);
        return (t < 0 && r <= 0) || (t > g.page.maxw && r >= g.page.maxw)
          ? g.noticeCursor()
          : void g.doScrollLeft(t);
      }),
      ...
      (this.doZoomIn = function (e) {
        if (!g.zoomactive) {
          ...
          (g.zoomrestore.style.width = g.win.css("width")),
            ...
            f.isios4 &&
              ((g.zoomrestore.scrollTop = x(window).scrollTop()),
          ...
          return (
            ("" != n &&
              ...
              g.win.css("backgroundColor", "#fff"),
            g.rail.css({ "z-index": y + 101 }),
            g.zoom.css({ "z-index": y + 102 }),
    ...
    T = function (e) {
      ...
      (this.nc = e),
        ...
        (this.doSnapy = function (e, o) {
          ...
          o < 0
            ? (t = !(o = 0))
            : o > d.nc.page.maxh && ((o = d.nc.page.maxh), (t = !0)),
            e < 0
              ? (t = !(e = 0))
              : e > d.nc.page.maxw && ((e = d.nc.page.maxw), (t = !0)),
            t
              ? d.nc.doScrollPos(e, o, d.nc.opt.snapbackspeed)
              : d.nc.triggerScrollEnd();
        }),
        (this.doMomentum = function (e) {
          ...
          var s,
            ...
            a,
            c,
            r = !(!d.speedy || !t) && d.speedy,
            t = !(!d.speedx || !t) && d.speedx;
          r || t
            ? (50 < (s = Math.max(16, d.steptime)) &&
                ((t = s / 50), (d.speedx *= t), (d.speedy *= t), (s = 50)),
              (d.demulxy = 0),
              ...
              (c = function () {
                ...
                d.speedx &&
                  ((l = Math.floor(d.lastscrollx - d.speedx * (1 - d.demulxy))),
                  ((d.lastscrollx = l) < 0 || n < l) && (e = 0.1)),
                  d.speedy &&
                    ((a = Math.floor(
                      d.lastscrolly - d.speedy * (1 - d.demulxy)
                    )),
                    ((d.lastscrolly = a) < 0 || i < a) && (e = 0.1)),
                  (d.demulxy = Math.min(1, d.demulxy + e)),
                  d.nc.synched("domomentum2d", function () {
                    d.speedx &&
                      (d.nc.getScrollLeft() != d.chkx && d.stop(),
                      (d.chkx = l),
                      ...
                      d.speedy &&
                        ...
                        (d.chky = a),
                        d.nc.setScrollTop(a)),
                      d.timer || (d.nc.hideCursor(), d.doSnapy(l, a));
                  }),
                  d.demulxy < 1
                    ? (d.timer = setTimeout(c, s))
                    : (d.stop(), d.nc.hideCursor(), d.doSnapy(l, a));
              })())
  ...
  (x.cssHooks.pageXOffset = {
    ...
    set: function (e, o) {
      var t = x.data(e, "__nicescroll") || !1;
      return (
        t && t.ishwscroll ? t.setScrollLeft(parseInt(o)) : l.call(e, o), this
      );
    },
  }),
  ...
  function a(e) {
    ...
    if (
      ...
      (this.each = function (e) {
        for (var o = 0, t = 0; o < r.length; o++) e.call(r[o], t++);
        return r;
      }),
  ...
  !(function (e, o, t) {
    ...
    (e.fn.getNiceScroll = function (e) {
      return void 0 === e
        ? new a(this)
        : (this[e] && x.data(this[e], "__nicescroll")) || !1;
    }),
    e.extend(e.expr[":"], {
    ...
    (x.fn.niceScroll = function (e, o) {
      void 0 === o &&
        ...
        (o = x.extend({}, o));
      var t = new a();
      void 0 === o && (o = {}), e && ((o.doc = x(e)), (o.win = x(this)));
      var r = !("doc" in o);
      return (
        r || "win" in o || (o.win = x(this)),
        this.each(function () {
          var e = x(this).data("__nicescroll") || !1;
          e ||
            ((o.doc = r ? x(this) : o.doc),
            (e = new i(o, x(this))),
    ...
    x.nicescroll || ((x.nicescroll = new a()), (x.nicescroll.options = z));
});
  ...
  s.extend(o.prototype, {
      ...
      e
        ...
        "dots" == this.settings.overlay
          ...
          : "plain" == this.settings.overlay &&
            this.$el.addClass("overlay-plain"),
        this.support &&
          (e.css("opacity", 0).css(this.transitionProp),
          setTimeout(function () {
    ...
    jump: function (s) {
      if (s >= this.numSlides)
        ...
        if (this.switching) this.pending = s;
        else {
          var i = this,
    ...
    (s.fn[a] = function (i) {
      return this.each(function () {
        s.data(this, "plugin_" + a) ||
          s.data(this, "plugin_" + a, new o(this, i));
      });
    });
  var r = s("[data-zs-src]");
  r.length > 0 &&
